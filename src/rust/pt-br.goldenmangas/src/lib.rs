...
const BASE_URL: &str = "https://goldenmangas.top";
...
fn get_manga_listing(listing: Listing, page: i32) -> Result<MangaPageResult> {
	parser::parse_manga_listing(String::from(BASE_URL), listing.name, page)
}
...
fn get_page_list(manga_id: String, id: String) -> Result<Vec<Page>> {
	parser::parse_page_list(String::from(BASE_URL), manga_id, id)
}
