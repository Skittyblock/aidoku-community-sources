...
fn get_manga_listing(listing: Listing, page: i32) -> Result<MangaPageResult>{
	let url = match listing.name.as_str() {
		"Latest" => format!("{}/list/New-Update/", NineMangaSource::default().base_url),
		"Hot" => format!("{}/list/Hot-Book/", NineMangaSource::default().base_url),
		_ => format!("{}/list/New-Book/", NineMangaSource::default().base_url),
	};
